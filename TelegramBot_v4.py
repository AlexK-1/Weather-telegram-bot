...
async def cmd_start(message: types.Message):
    print("/start")
    await message.reply("Приветствую! Вы можете узнать, как пользоваться этим ботом здесь /help")

@dp.message(Command("help"))
async def cmd_help(message: types.Message):
    print("/help")
    await message.reply("Чтобы определить, какая сейчас погода в определённом городе, "
                        "нужно ввести команду /weather и после неё через пробел название интересующего вас города.\n"
                        "Например: <code>/weather Москва</code>\n"
                        "Чтобы узнать прогноз погоды на 2 дня вперёд, вы должны ввести команду /forecast и "
                        "после неё через пробел название города.\n"
                        "Например: <code>/forecast Москва</code>")
